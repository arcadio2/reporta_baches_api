...
from .views import ReportesTrabajador, ReportesCiudadanos, VisualizarImagen, ReportesTiempoReal
...
routers.register('tiempo-real',ReportesTiempoReal,'tiempo-real')
